...
from aiwork.modes.base import AgentMode
from aiwork.runtime.hooks import HookContext
...
class OMPModeBase(AgentMode):
    ...
    def setup(self, workspace: object) -> None:
        ...
        from aiwork.loop.gates import StopHandler, StopHandlerRegistration
