...
from aiwork.loop.gates.base import StopAction, StopHandlerResult
from aiwork.loop.gates.loop_gate import LoopGate
...
class TeamPipelineGate(LoopGate):
    ...
    def activate_for_team(
        ...
        try:
            from aiwork.agents.fork_project import begin_fork_scope
