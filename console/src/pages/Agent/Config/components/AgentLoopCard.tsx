    ...
    <>
      <Form.Item
        ...
        extra={t(
          ...
          "Describe when the result is complete. AIWork automatically injects the completion-signal output instruction.",
        )}
      >
      ...
      <div className={loopStyles.fieldGrid}>
        <Form.Item
          ...
          tooltip={t(
            ...
            "AIWork injects this signal into the check prompt and instructs the agent to output only it. Matching is exact after trimming whitespace and ignoring case.",
          )}
        >
          <Input maxLength={64} />
        </Form.Item>
        ...
        <div>
          ...
          <p>
            {t(
              ...
              "Build a saved pipeline from AIWork-owned gates.",
            )}
          </p>
        </div>
        <div>
