...
class StandaloneRubricGate(QualitativeRubricGate):
    """Legacy alias kept for older call sites.

    Maps ``prompt`` / ``max_interventions`` onto the
    QualitativeRubricGate constructor.
    """
    ...
    def __init__(
        ...
        super().__init__(
            rubric=prompt,
            max_evaluations=max_interventions,
        )
