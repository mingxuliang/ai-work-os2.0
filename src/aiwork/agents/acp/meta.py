...
ACP_CODING_PROJECT_META_KEY = "aiwork.coding_project_dir"
ACP_EPHEMERAL_META_KEY = "aiwork.ephemeral"
ACP_APPROVAL_EXPIRES_AT_META_KEY = "aiwork.approval_expires_at"
