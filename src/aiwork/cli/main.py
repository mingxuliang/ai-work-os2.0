...
@click.group(
    ...
    lazy_subcommands={
        ...
        "app": ("aiwork.cli.app_cmd", "app_cmd", ".app_cmd"),
        "channels": (
            "aiwork.cli.channels_cmd",
            "channels_group",
            ".channels_cmd",
        ),
        "channel": (
        ...
        "daemon": ("aiwork.cli.daemon_cmd", "daemon_group", ".daemon_cmd"),
        "chats": ("aiwork.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "chat": ("aiwork.cli.chats_cmd", "chats_group", ".chats_cmd"),
        "clean": ("aiwork.cli.clean_cmd", "clean_cmd", ".clean_cmd"),
        "cron": ("aiwork.cli.cron_cmd", "cron_group", ".cron_cmd"),
        "env": ("aiwork.cli.env_cmd", "env_group", ".env_cmd"),
        "init": ("aiwork.cli.init_cmd", "init_cmd", ".init_cmd"),
        "models": (
            "aiwork.cli.providers_cmd",
            "models_group",
            ".providers_cmd",
        ),
        ...
        "desktop": ("aiwork.cli.desktop_cmd", "desktop_cmd", ".desktop_cmd"),
        "update": ("aiwork.cli.update_cmd", "update_cmd", ".update_cmd"),
        "shutdown": (
            "aiwork.cli.shutdown_cmd",
            "shutdown_cmd",
            ".shutdown_cmd",
        ),
