...
def get_tool_config(tool_name: str) -> Optional[Dict[str, Any]]:
    ...
    Example:
        >>> from aiwork.plugins import get_tool_config
...
class PluginApi:  # pylint: disable=too-many-public-methods
    ...
    def register_channel(
        ...
        ``aiwork.app.channels.base.BaseChannel`` with a ``channel``
    ...
    def register_tool(
        ...
        - Adds the function to ``aiwork.agents.tools`` module
        ...
        def _startup_register():
            try:
                import aiwork.agents.tools as tools_module
