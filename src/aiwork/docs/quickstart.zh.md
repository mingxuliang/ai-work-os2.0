...
- 对于 QwenPaw Local（llama.cpp），你可以直接在控制台的提供商设置中下载模型，或者手动将 GGUF 模型文件放到本地模型目录中（默认 `~/.aiwork/local_models/models/<org>/<model>`，例如 `~/.aiwork/local_models/models/Qwen/Qwen3-0.6B-GGUF`）。
