...
| `/daemon logs` or `/daemon logs 50` | View last N lines of log (default 100, max 2000, from `aiwork.log` in working directory) | ✅   | ✅       |
...
View the last N lines of `aiwork.log` in the working directory. Default 100 lines, maximum 2000 lines.
