...
你也可以直接修改智能体配置文件（`~/.aiwork/workspaces/{agent_id}/agent.json`）中的 `system_prompt_files` 字段来管理人设文件的加载：
...
- **工作区位置**：`$QWENPAW_WORKING_DIR/workspaces/QwenPaw_QA_Agent_0.2/`（默认为 `~/.aiwork/workspaces/QwenPaw_QA_Agent_0.2/`）
