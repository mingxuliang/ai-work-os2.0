...
[Quick Start](https://aiwork.agentscope.io/docs/quickstart) for details:
...
[Quick Start](https://aiwork.agentscope.io/docs/quickstart).
...
See the site [Release notes](https://aiwork.agentscope.io/release-notes/?lang=en)
...
[Models](https://aiwork.agentscope.io/docs/models) doc for details:
...
[CLI → Models and environment variables → qwenpaw models](https://aiwork.agentscope.io/docs/cli#qwenpaw-models).
...
[Skills](https://aiwork.agentscope.io/docs/skills).

### How to configure MCP

Go to **Agent -> MCP** in Console. You can enable/disable/delete/create MCP
clients there. See [MCP](https://aiwork.agentscope.io/docs/mcp).
