...
You can also directly edit the `system_prompt_files` field in the agent configuration file (`~/.aiwork/workspaces/{agent_id}/agent.json`) to manage persona file loading:
...
- **Workspace location**: `$QWENPAW_WORKING_DIR/workspaces/QwenPaw_QA_Agent_0.2/` (defaults to `~/.aiwork/workspaces/QwenPaw_QA_Agent_0.2/`)
